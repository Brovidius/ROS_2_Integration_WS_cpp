...
class  Test_rov(Node):
    ...
    def __init__(self):
        ...
        # ROS 2 publisher
        self.publisher_ = self.create_publisher(String, '/bluerov2_pid/bluerov2/observer/nlo/odom_ned', 1)
        # Call the function
...
def main():
    ...
    rclpy.spin(Test_rov()) # Runs the node in a loop
    
    # Once loop ends, things get deleted
    Test_rov.destroy_node() 
    rclpy.shutdown()
